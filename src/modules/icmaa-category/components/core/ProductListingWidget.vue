<template>
  <div data-test-id="ProductListingWidget" class="product-listing t-flex t-flex-wrap t-justify-start lg:t--mx-2" :class="[ apperance ] ">
...
export default {
  ...
  computed: {
    ...
    isIcmaaCategoryList () {
      return this.$route.path === '/de/merchandise'
    }
  },
  methods: {
    async fetchProducts () {
