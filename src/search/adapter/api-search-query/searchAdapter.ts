...
import { SearchAdapter as SearchAdapterOrginal } from '@vue-storefront/core/lib/search/adapter/api-search-query/searchAdapter'

/**
 * This class is an overwrite of the original one
 *
 * Changes:
 * - Add `decompressItem` method to decompress attributes that are stripped by the API's `fieldsToCompress` option of the
 *   `api-search-query` adapter. This otherwise leads into wrong product data in state-management.
 *   @see https://github.com/DivanteLtd/vue-storefront/issues/4629
 *   @see https://www.icmaa.info/redmine/issues/204533
 */
export class SearchAdapter extends SearchAdapterOrginal {
