...
const AffiliatesComponent = () => import(/* webpackChunkName: "vsf-icmaa-cms-page-custom-affiliates" */ 'theme/components/core/blocks/ICMAA/Cms/Pages/Affiliates.vue')
...
export const routes: any = [
  ...
  { name: 'affiliates', path: '/:identifier', component: AffiliatesComponent }
]
