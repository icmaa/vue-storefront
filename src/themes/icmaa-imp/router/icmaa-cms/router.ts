...
const ServiceSizeComponent = () => import(/* webpackChunkName: "vsf-icmaa-cms-page-custom-size" */ 'theme/components/core/blocks/ICMAA/Cms/Pages/ServiceSize.vue')
...
export const routes: any = [
  ...
  { name: 'size', path: '/:identifier', component: ServiceSizeComponent }
]
