<template>
  <router-link :to="productLink" tag="li" class="t-flex t-flex-wrap t-w-full t-bg-white t-py-4 t-cursor-pointer">
    ...
    <div class="t-w-1/12 md:t-w-1/12 t-pr-5 t-self-center t-text-right">
