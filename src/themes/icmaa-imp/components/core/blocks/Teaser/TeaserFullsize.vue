<template>
  <div data-test-id="TeaserFullsize" class="teaser-fullsize t-mx-0 sm:t-mx-4 t-cursor-pointer t-webkit-tap-transparent" @click="redirect" @mouseover="onHover" @mouseleave="onHover">
    <div class="t-relative">
      <picture-component :alt="teaser.text1 | translate | htmlDecode" :title="teaser.text1 | translate | htmlDecode" :src="imageUrl" :width="size.width" :height="size.height" :placeholder="true" :sizes="sizes" :ratio="ratio" class="t-w-full" />
