  ...
  <nav role="service-navigation">
    <ul>
      <li class="t-w-full t-relative">
        <a class="t-block lg:t-hidden t-bg-white t-border-base-light t-border t-px-3 t-py-2 t-appearance-none focus:outline-none t-text-black focus:shadow-outline" @click="toggleView">Service
