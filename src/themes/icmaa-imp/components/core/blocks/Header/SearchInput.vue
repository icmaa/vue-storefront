<template>
  <div class="t-flex t-w-full t-flex-wrap t-items-stretch">
    <input type="text" class="t-flex-1 t-w-px md:t-flex-fix md:t-w-1/2 lg:t-w-2/5 t-leading-normal t-border-0 t-border-b t-border-base-light t-h-10 t-pl-3 t-pr-1 t-text-sm t-text-base-darkest placeholder:t-opacity-100" :placeholder="$t('Search')" @focus="toggleSearchpanel">
