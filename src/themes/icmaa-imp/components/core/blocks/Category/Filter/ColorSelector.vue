<template>
  <button class="t-flex t-items-center t-justify-center t-border t-border-base-lighter t-rounded-full t-w-10 t-h-10 t-mr-4 t-mb-2 hover:t-border-base-tone" :class="[isActive ? '' : '']" @click="$emit('change', variant)" :aria-label="variant.label" :style="colorFrom(variant)">
