<template>
  <div class="newsletter" v-if="!isSubscribed">
    ...
    <div class="t-flex t-mb-2 ">
      <input type="text" value="" :placeholder="$t('Your email address')" @focus="showNewsletterPopup" class="t-flex t-flex-expand t-border t-border-r-0 t-border-base-light t-rounded-none t-rounded-tl-sm t-rounded-bl-sm t-text-sm t-h-10 t-px-2 placeholder:t-text-base-light">
