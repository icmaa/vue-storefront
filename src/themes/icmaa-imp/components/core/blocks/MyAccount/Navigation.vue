<template>
  <nav class="customer-account">
    <div class="t-flex t-flex-wrap t-bg-white">
      ...
      <ul class="t-flex t-flex-wrap t-overflow-hidden" :class="[ visible ? 't-pt-3 t-max-h-screen-100 t-border-b t-border-base-lightest lg:t-border-none' : 't-max-h-0' ]" style="transition: all .5s">
